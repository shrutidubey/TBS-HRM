...
@Component({
  selector: 'app-mng-tbirthday',
  templateUrl: './mng-tbirthday.component.html',
  styleUrls: ['./mng-tbirthday.component.css']
})
export class MngTbirthdayComponent implements OnInit {
