...
@Component({
  selector: 'app-emp-tbirthday',
  templateUrl: './emp-tbirthday.component.html',
  styleUrls: ['./emp-tbirthday.component.css']
})
export class EmpTbirthdayComponent implements OnInit {
  name: String;
  username: String;
  email: String;
  password: String;
