...
@Component({
  selector: 'app-mng-leaverec',
  templateUrl: './mng-leaverec.component.html',
  styleUrls: ['./mng-leaverec.component.css']
})
export class MngLeaverecComponent implements OnInit {
