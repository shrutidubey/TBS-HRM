  ...
  onSubmit(form: NgForm) {
   /* if (form.value._id == "") {
      ...
      //this.newpassword
        ...
        this.employeeService.putforgotEmployee(form.value).subscribe((res) => {
...
//var  abc:[]
   ...
   // var  username = JSON.parse(localStorage.getItem('user')).username;
   var username = this.employeeService.getusername();
   console.log("username"+username);
  // console.log("newpassword"+newpassword);
   

    this.employeeService.findByEmail(username).subscribe((res)=>{
